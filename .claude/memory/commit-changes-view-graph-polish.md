...
metadata: 
  ...
  modified: 2026-08-08T05:47:00.748Z
---
...
共享逻辑集中在 `workbench/scm/commitChanges/{graphFollow,graphPayloadCache}.ts` 与 `workbench/gitGraph/useGraphKeyboardNav.ts`（git/perforce 两编辑器复用）。相关 [[dirty-diff-inline-peek-feature]]、[[editor-input-identity-isolation]]。
