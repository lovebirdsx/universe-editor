...
- 仅 CI Windows 确定性挂+断言基于行/列宽度（getBoundingClientRect/scrollWidth）+失败截图视口恒等于 runner 屏宽（1024x718）=runner 屏 1024x768 夹窄默认 1280 窗口，布局断言在 Windows 上测的是另一个场景 → 案例 92
