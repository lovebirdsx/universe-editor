 ...
 *  The `file:` scheme provider: local disk over `fs.promises`, trash via the
 *  Electron shell. Registered into the scheme-routed FileService by
 *  FileSystemMainService.
 *--------------------------------------------------------------------------------------------*/
