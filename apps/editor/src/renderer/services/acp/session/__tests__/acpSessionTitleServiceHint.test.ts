 ...
 *  Tests for the one-time "no session-title model configured" hint: a single
 *  Info notification that deep-links to the session-title model picker, gated
 *  by a GLOBAL storage flag written before the toast fires.
 *--------------------------------------------------------------------------------------------*/
