 ...
 *  the view title bar (SessionsViewToolbar) while the find widget and the
 *  filtered list live in the body (SessionListBody); they have no common React
 *  ancestor, so the state is held here as observables.
 *
