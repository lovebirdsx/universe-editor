...
export const EN_US_MESSAGES: MessageMap = {
  ...
  'status.selectLanguageMode': 'Select Language Mode',
  ...
  'action.changeLanguageMode': 'Change Language Mode',
  ...
  'action.selectForCompare.title': 'Select for Compare',
  'action.compareWithSelected.title': 'Compare with Selected',
  'action.compareFiles.title': 'Compare Selected',
