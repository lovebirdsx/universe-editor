...
export const ZH_CN_MESSAGES: MessageMap = {
  ...
  'ai.verify.noProvider': '未注册提供方协议"{protocol}"。',
  ...
  'aiModels.pricingSource.none.option': '无',
  ...
  'aiModels.usageSource.none.option': '无',
  ...
  'acp.usage.col.cost': '费用',
  'acp.usage.col.model': '模型',
  'acp.usage.col.requests': '请求数',
  ...
  'acp.usage.noBreakdown': '没有按模型的明细数据。',
