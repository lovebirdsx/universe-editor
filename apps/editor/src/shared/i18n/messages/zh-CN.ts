...
export const ZH_CN_MESSAGES: MessageMap = {
  ...
  'aiModels.section.types': '提供方类型',
  'aiModels.section.instances': '提供方实例',
  'aiModels.instances.empty': '尚无提供方实例。添加一个以接入 AI 服务。',
  ...
  // provider type card
  'aiModels.type.badge.builtin': '内置',
  'aiModels.type.badge.custom': '自定义',
  'aiModels.type.baseUrl': '默认 Base URL',
  'aiModels.type.baseUrl.placeholder': '无默认',
  'aiModels.type.requiresApiKey': '需要 API 密钥',
  'aiModels.type.models': '模型目录',
  'aiModels.type.noModels': '该类型尚未声明模型。',
  'aiModels.type.refreshPrices': '从网关刷新价格',
  'aiModels.type.refreshPrices.noSource': '此类型未配置价格来源',
  'aiModels.type.remove.confirm': '移除提供方类型 {type}？',
  'aiModels.type.remove.remove': '移除',
  'aiModels.type.remove.bound': '无法移除：仍有 {count} 个提供方实例绑定此类型。',

  // pricing
  'aiModels.origin.model': '模型',
  'aiModels.origin.gateway': '网关',
  'aiModels.origin.type': '类型',
  'aiModels.origin.catalog': '内置目录',
  'aiModels.origin.unknown': '费率未知',
  'aiModels.pricing.edit': '编辑费率',
  'aiModels.pricing.fill': '填写费率',
  'aiModels.pricing.perMillion': '每 1M tokens',
  'aiModels.pricing.input': '输入',
  'aiModels.pricing.output': '输出',
  'aiModels.pricing.cacheRead': '缓存读',
  'aiModels.pricing.cacheWrite': '缓存写',
  'aiModels.pricing.currency': '货币',
  'aiModels.pricing.save': '保存',
  'aiModels.pricing.clear': '清除',
  'aiModels.pricing.cancel': '取消',

  // provider instance card
  'aiModels.instance.test': '测试连接',
  'aiModels.instance.remove.confirm': '移除提供方 {name}？',
  ...
  'aiModels.apiKey.editPrompt': '输入 {name} 的 API 密钥（以明文保存在 aiSettings.json）。',
  'aiModels.apiKey.empty': 'API 密钥不能为空。',
  'aiModels.apiKey.clearBtn': '清除 API 密钥',
  'aiModels.apiKey.clearConfirm': '清除已存储的 {name} API 密钥？',
  'aiModels.apiKey.clearAction': '清除',
  'aiModels.rates.title': '网关价目表',
  'aiModels.rates.line': '{count} 个模型 · 更新于 {time}',
  'aiModels.rates.none': '未从网关获取到价目表。',
  ...
  'aiModels.addProvider.type': '提供方类型',
  'aiModels.addProvider.builtin': '（内置）',
  'aiModels.addProvider.custom': '（自定义）',
  'aiModels.addProvider.newType': '＋ 新建类型…',
  'aiModels.addProvider.reuse': '将复用 {type} 的 {count} 个模型与费率配置。',
  'aiModels.addProvider.newType.id': '类型 id',
  'aiModels.addProvider.newType.idEmpty': '类型 id 不能为空。',
  'aiModels.addProvider.newType.idSlash': "类型 id 不能包含 '/'。",
  'aiModels.addProvider.newType.idExists': '该类型 id 已存在。',
  'aiModels.addProvider.newType.label': '标签',
  'aiModels.addProvider.newType.labelPlaceholder': '显示名称',
  'aiModels.addProvider.newType.protocol': '协议',
  'aiModels.addProvider.newType.baseUrl': '默认 Base URL',
  'aiModels.addProvider.newType.requiresApiKey': '需要 API 密钥',
  'aiModels.addProvider.name': '名称',
  'aiModels.addProvider.nameEmpty': '名称不能为空。',
  'aiModels.addProvider.nameSlash': "名称不能包含 '/'。",
  'aiModels.addProvider.nameExists': '该类型下已存在同名提供方。',
