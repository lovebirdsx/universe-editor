...
export const ZH_CN_MESSAGES: MessageMap = {
  ...
  'monaco.command.addCursorAbove.label': '在上方添加光标',
  'monaco.command.addCursorBelow.label': '在下方添加光标',
  'monaco.command.addSelectionToNextMatch.label': '将选定内容添加到下一个匹配项',
  'monaco.command.blockComment.label': '切换块注释',
  'monaco.command.commentLine.label': '切换行注释',
  'monaco.command.copyLineDown.label': '向下复制行',
  'monaco.command.copyLineUp.label': '向上复制行',
  'monaco.command.deleteLine.label': '删除行',
  'monaco.command.find.label': '查找',
  'monaco.command.formatDocument.label': '格式化文档',
  'monaco.command.gotoDefinition.label': '转到定义',
  'monaco.command.indentLines.label': '增加缩进',
  'monaco.command.jumpToBracket.label': '跳转到匹配括号',
  'monaco.command.moveLineDown.label': '向下移动行',
  'monaco.command.moveLineUp.label': '向上移动行',
  'monaco.command.outdentLines.label': '减少缩进',
  'monaco.command.peekDefinition.label': '速览定义',
  'monaco.command.redo.label': '重做',
  'monaco.command.rename.label': '重命名符号',
  'monaco.command.replace.label': '替换',
  'monaco.command.selectAll.label': '全选',
  'monaco.command.selectHighlights.label': '选择所有匹配项',
  'monaco.command.triggerParameterHints.label': '触发参数提示',
  'monaco.command.triggerSuggest.label': '触发建议',
  'monaco.command.undo.label': '撤销',
  'panel.output': '输出',
  'settings.editor': '编辑器',
