 ...
 *  Shared child-process environment assembly. Centralizes the env denylist +
 *  `ELECTRON_RUN_AS_NODE` handling that AcpHost, AcpTerminal, ExtensionHost, the
 *  remote deployer, and the terminal PTY host each rely on. Electron-free, so both
 *  apps/editor main and a remote Node server import it from node-services.
 *--------------------------------------------------------------------------------------------*/
