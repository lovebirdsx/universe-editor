...
let _debugGetObservableGraph: typeof debugGetObservableGraph = debugGetObservableGraph
...
export abstract class ConvenientObservable<T, TChange> implements IObservableWithChange<
  T,
  TChange
> {
  get TChange(): TChange {
